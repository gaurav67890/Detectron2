...
ENTRYPOINT ["python3","trainer-main-gpu.py","--damage_name","crack","--max_iter","1500","--check_period","500","--thresh_test","0.3","--num-gpus","4","--config-file","configs/COCO-InstanceSegmentation/mask_rcnn_R_101_FPN_3x.yaml"]
