...
ENTRYPOINT ["python3","trainer-main-gpu_16.py","--damage_name","dent","--max_iter","10000","--check_period","500","--thresh_test","0.4","--num-gpus","4","--config-file","configs/COCO-InstanceSegmentation/mask_rcnn_R_101_FPN_3x.yaml","--batch_size","16"]
